...
name = names[2] # Change this to 1-12 as needed

si_data = torch.load(f"/root/SafeDiffuser/logs/walker2d-medium-v2/plans/H600_T20_d0.99/40/{name}/plan_observation.pt")  # [6496, 600, 17]
ai_data = torch.load(f'/root/SafeDiffuser/logs/walker2d-medium-v2/plans/H600_T20_d0.99/40/{name}/plan_action.pt')  # [6496, 600, 6]
